...
public class menudb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menudb);
        ...
        btCrearM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(menudb.this, "basedatos1", null, 1);
                ...
                if(kcal.isEmpty()){
                    ...
                    bd.insert("alimentos1", null, registro);
                    bd.close();
                    etNombreM.setText("");
                    etKcal100gM.setText("");
                    Toast.makeText(menudb.this, "Los datos introducidos se han guardado con éxito", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btEliminarM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int cant = bd.delete("alimentos1", "nombre='" + nombre +"'", null);
                bd.close();
                if(cant == 1){
                    Toast.makeText(menudb.this, "Se han eliminado los datos", Toast.LENGTH_SHORT).show();
                    etNombreM.setText("");
                    etKcal100gM.setText("");
                }else{
                    Toast.makeText(menudb.this, "No existen datos para eliminar", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btConsultarM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SQLiteDatabase bd = admin.getWritableDatabase();
                String nombre = etNombreM.getText().toString().trim();
                Cursor fila = bd.rawQuery("SELECT kcal FROM alimentos1 WHERE nombre='" + nombre +"'", null);
                if (fila.moveToFirst()){
                    etKcal100gM.setText(fila.getString(0));
                } else
                    Toast.makeText(menudb.this,"No existen datos almacenados", Toast.LENGTH_SHORT).show();
                bd.close();
            }
        });
        ...
        */
        btRegistrarM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor fila = bd.rawQuery("SELECT SUM(kcalcontado) FROM bd21 WHERE fecha='" + fecha +"'", null);
                if (fila.moveToFirst()){
        ...
        btActualizarM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (a > b) {
                    Toast.makeText(menudb.this, "Has superado el consumo de calorias", Toast.LENGTH_SHORT).show();
                }
                if (b >= a) {
                    Toast.makeText(menudb.this, "Sigue así!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btEliminarUltimoM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int cant = bd.delete("bd21", "ID=(SELECT MAX(ID) FROM bd21)", null);
                //int cant = bd.delete("alimentos1", "nombre='" + nombre +"'", null);                  AÑADIR ; ??? ANTES DE " ?????
